...
import DocumentSigsM from "./document_sigs_m";

export default class DocumentSigs extends React.Component {
    ...
    render() {
        return (
            <div>
                <Card className="medi">
                    <CardHeader>
                        <span className="text-uppercase bold">Documentos SIG</span>
