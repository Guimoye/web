                        ...
                        <Alert color="danger" isOpen={this.state.error != null} fade={true}>
                            {this.state.error}
                                ...
                                <Row className="form-group">
                                   ...
                                   {    
                                          //   console.log(this.state.selecciones)
                                       // console.log(this.labeeel)
                                   /*
                                        let optionss = [];
                                        //  console.log('explota1: '+rsp.item.id_unidad);
                                          this.state.unidades.map((o) => optionss.push({
                                              value: o.id,
                                              label: o.placa
                                          }));
                                       ...
                                       */
                                        ...
                                        <Select
                                            name="id_unidad"
                                            //defaultInputValue={'hola'}
                                            //value={props.input.value?props.input.value:"Any"}
                                            //onChange={value => props.input.onChange(value)}
                                            //defaultInputValue={this.state.seleccion.nombre}
